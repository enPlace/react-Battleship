...
<p>This is not meant to be an explanation of every function that the module contains, but rather an explanation of the algorithm's process so that reading the code in the module becomes much more straightforward.</p>
